function discover_paris_patches_parallel_single_nogt_20x1(seed_pos_image_id, ...
...
seed_image_struct = load_cached_features_hos(dataset.trainset, ...
                     dataset.year, pos_image_ids{seed_pos_image_id}, opts);
...
for pos_i = 1:num_pos_images
  ...
  this_pos_image_windows = load_cached_features_hos(dataset.trainset, ...
                                dataset.year, pos_image_ids{pos_i}, opts);
  % remove ground truth boxes                            
...
for neg_i = 1:num_neg_images
  ...
  this_neg_image_windows = load_cached_features_hos(dataset.trainset, ...
                                dataset.year, neg_image_ids{neg_i}, opts);
  % remove ground truth boxes                                                    
